  ...
  <div class="game-intro">
    ...
    <div class="role-description">
      ...
      <div v-if="isQuestioner">
        <h4>提问者目标：</h4>
        <ul>
          <li>你的主要目标是从回答者中找出真人玩家</li>
          <li>每轮你可以选择一个预设问题或自己输入问题</li>
          <li>根据所有玩家的回答，选择一个你认为是真人的玩家</li>
          <li>如果选对了真人，你就赢得游戏。如果选错了，这个AI会退出游戏，继续下一轮</li>
          <li>你也可以猜测某个玩家使用的AI模型，每次猜测会消耗2点积分，猜对会获得4点积分</li>
        </ul>
        <h4>积分规则：</h4>
        <ul>
          <li>第1轮找出真人：获得8积分</li>
          ...
          <li>第3轮找出真人：获得2积分</li>
          <li>第4轮找出真人：获得1积分</li>
          <li>猜对AI模型：获得4积分（消耗2积分）</li>
        </ul>
      </div>
      <div v-else>
        <h4>回答者目标：</h4>
        <ul>
          <li>你是一个真人玩家，但要假装自己是AI</li>
          <li>每轮你会收到提问者的问题，和AI一起回答</li>
          <li>你的目标是让提问者误以为你是AI，尽可能多地存活回合</li>
        </ul>
        <h4>积分规则：</h4>
        <ul>
          <li>存活1轮：获得1积分</li>
